    ...
    <div class="bg-light rounded p-3 p-md-4">
        <div class="d-flex align-items-center justify-content-between mb-3 mb-md-4">
            ...
            <div class="d-flex flex-wrap" style="gap: 8px;">
                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#forwardedMessageModal">
                    Previous Minutes
                </button>
                <a class="btn btn-sm btn-primary" href="{{ url()->previous() }}"><i class="fa fa-arrow-left mr-2"></i>Back</a>
            </div>
        </div>
